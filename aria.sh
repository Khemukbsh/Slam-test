...
aria2c --enable-rpc --rpc-listen-all=false --rpc-listen-port 6800 --check-certificate=false \
   ...
   --bt-tracker="[$tracker_list]" --bt-max-peers=0 --bt-tracker-connect-timeout=300 --bt-stop-timeout=900 --seed-time=0.01 --min-split-size=10M \
   ...
   --max-file-not-found=20 --max-tries=20 --auto-file-renaming=true \
